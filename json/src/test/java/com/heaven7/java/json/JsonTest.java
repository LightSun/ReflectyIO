...
import com.heaven7.java.json.entity.Info;
import com.heaven7.java.json.entity.Person;
...
public class JsonTest {
    ...
    private final JsonWriter mWriter = new JsonWriter(sw);
