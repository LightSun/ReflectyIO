...
public class Person {
    ...
    public boolean equals(Object o) {
        ...
        return age == person.age &&
                ...
                Objects.equals(mapListInfo, person.mapListInfo) &&
                Objects.equals(infoList, person.infoList) &&
                Objects.equals(infoMap, person.infoMap) &&
               // Objects.equals(infoMap2, person.infoMap2) &&
                Objects.equals(info, person.info) &&
                Objects.equals(text, person.text);
    }

    @Override
    public int hashCode() {
        return Objects.hash(age, name, list, map, listMap, mapList, mapListInfo, infoList, infoMap, info, text);
    }
}
